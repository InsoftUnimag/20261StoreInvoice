...
class ConsultarFormaPagoLiquidacionUseCaseTest {

    @Mock
    private LiquidacionRepository liquidacionRepository;

    private ConsultarFormaPagoLiquidacionUseCase useCase;

    private LiquidacionCliente liquidacionCliente;

    @BeforeEach
    void setUp() {
        useCase = new ConsultarFormaPagoLiquidacionUseCase(liquidacionRepository);
    ...
    @Test
    void ejecutar_pedidoConLiquidacion_retornaFormaPago() {
