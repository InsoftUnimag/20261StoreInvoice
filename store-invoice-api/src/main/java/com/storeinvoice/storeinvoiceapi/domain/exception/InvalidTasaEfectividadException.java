...
/**
 * Excepción de dominio para valores de tasa de efectividad fuera del rango permitido (-100 a 100).
...
public final class InvalidTasaEfectividadException extends DomainException {
    ...
    public InvalidTasaEfectividadException(final int valor) {
        super("La tasa de efectividad debe estar entre -100 y 100, pero se recibió: " + valor);
    }
}
